...
import lifestyle from "../../assets/img/cap.png";
import apparel from "../../assets/img/sweater.png";
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <article className="rounded-3xl border-2 border-zinc-900 bg-[#273357] p-4">
            ...
            <p className="mt-3 text-sm leading-6 text-zinc-50">
              Cool sticker items to display in your space.
            </p>
          ...
          <article className="rounded-3xl border-2 border-zinc-900 bg-[#273357] p-4">
            ...
            <p className="mt-3 text-sm leading-6 text-zinc-50">
              Slick lifestyle items for your daily routine.
            </p>
            <Button to="/products" className="mt-4" variant="primary">
              Shop Merch
            </Button>
